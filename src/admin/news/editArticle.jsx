...
export default function EditArticle(){
    ...
    return(
        <Container>
            <Typography align='center' gutterBottom variant="h1">Edit Article</Typography>

            <Grid container className={classes.container}>
                <Grid item sm={11} >
                    <form onSubmit={handleSubmit}>
                        <FormGroup className={classes.formGroup} >
                                <TextField id="standard-basic" label="Title" variant="standard" value={article.title} name="title" onChange={handleChange} />
                        </FormGroup>
